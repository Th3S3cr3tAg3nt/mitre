...
Adversaries may also execute malicious content by planting malicious [JavaScript](techniques/T1059/007) within Electron applications.(Citation: Electron Security)
## Mitigations
