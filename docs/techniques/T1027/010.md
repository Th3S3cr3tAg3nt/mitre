...
# Command Obfuscation
## ID:T1027/010
Adversaries may obfuscate content during command execution to impede detection. Command-line obfuscation is a method of making strings and patterns within commands and scripts more difficult to signature and analyze. This type of obfuscation can be included within commands executed by delivered payloads (e.g., [Phishing](techniques/T1566) and [Drive-by Compromise](techniques/T1189)) or interactively via [Command and Scripting Interpreter](techniques/T1059).(Citation: Akamai JS)(Citation: Malware Monday VBE)
