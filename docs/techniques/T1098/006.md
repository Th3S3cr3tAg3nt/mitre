...
This account modification may immediately follow [Create Account](techniques/T1136) or other malicious account activity. Adversaries may also modify existing [Valid Accounts](techniques/T1078) that they have compromised.  
