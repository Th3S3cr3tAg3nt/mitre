...
By modifying conditional access policies, such as adding additional trusted IP ranges, removing [Multi-Factor Authentication](techniques/T1556/006) requirements, or allowing additional [Unused/Unsupported Cloud Regions](techniques/T1535), adversaries may be able to ensure persistent access to accounts and circumvent defensive measures.
## Mitigations
